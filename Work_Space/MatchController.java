...
private void addMatch(ActionEvent event) throws SQLException, IOException
 {
	...
	System.out.println(matchTime);
 	myConnection = DBHandler.getConnection();
 	String addMatch = "INSERT INTO match (Game_GameID,Tournament_TournamentID,matchDate,teams_TeamID2,teams_TeamID1)"+ "VALUES (?,?,?,?,?)";
 	try
 	{
 		PreparedStatement preparedStatement = myConnection.prepareStatement(addMatch);
 		preparedStatement.setInt (1, GameID);
 		preparedStatement.setInt(2, TournamentID);
 		preparedStatement.setTimestamp(3, java.sql.Timestamp.valueOf(matchTime));
 		preparedStatement.setInt(4, matchTeam2ID);
 		preparedStatement.setInt(5, matchTeam1ID);
