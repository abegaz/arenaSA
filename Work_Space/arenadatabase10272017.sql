...
--
-- Table structure for table `gamescoretable`
--

DROP TABLE IF EXISTS `gamescoretable`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gamescoretable` (
  `GameScoreTableID` int(11) NOT NULL,
  `game_GameID` int(11) NOT NULL,
  `TestCol1` int(11) NOT NULL,
  `TestCol2` int(11) NOT NULL,
  `TestNameCol1` int(11) NOT NULL,
  `TestNameCol2` int(11) NOT NULL,
  `TestNameCol3` int(11) NOT NULL,
  PRIMARY KEY (`GameScoreTableID`,`game_GameID`),
  KEY `fk_GameScoreTable_game1_idx` (`game_GameID`),
  CONSTRAINT `fk_GameScoreTable_game1` FOREIGN KEY (`game_GameID`) REFERENCES `game` (`GameID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `gamescoretable`
--

LOCK TABLES `gamescoretable` WRITE;
/*!40000 ALTER TABLE `gamescoretable` DISABLE KEYS */;
/*!40000 ALTER TABLE `gamescoretable` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `league` (
  ...
  `users_userRoleID` int(11) NOT NULL,
  `arena_ArenaID` int(11) NOT NULL,
  PRIMARY KEY (`LeagueID`,`ExpertRatingFormula_ExpertRatingFormulaID`,`users_userID`,`users_userRoleID`,`arena_ArenaID`),
  KEY `fk_League_ExpertRatingFormula1_idx` (`ExpertRatingFormula_ExpertRatingFormulaID`),
  KEY `fk_league_users1_idx` (`users_userID`,`users_userRoleID`),
  ...
  CONSTRAINT `fk_league_users1` FOREIGN KEY (`users_userID`, `users_userRoleID`) REFERENCES `users` (`userID`, `userRoleID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `match` (
  ...
  `GameScoreTable_GameScoreTableID` int(11) NOT NULL,
  PRIMARY KEY (`MatchID`,`MatchStatus_MatchStatusID`,`Game_GameID`,`Tournament_TournamentID`,`Tournament_Arena_ArenaID`,`Tournament_League_LeagueID`,`Tournament_TournamentStyleCode_TournamentStyleCodeID`,`GameScoreTable_GameScoreTableID`),
  ...
  KEY `fk_match_GameScoreTable1_idx` (`GameScoreTable_GameScoreTableID`),
  ...
  CONSTRAINT `fk_match_GameScoreTable1` FOREIGN KEY (`GameScoreTable_GameScoreTableID`) REFERENCES `gamescoretable` (`GameScoreTableID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-10-26 22:07:00
