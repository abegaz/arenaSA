...
CREATE TABLE `advertisment` (
  ...
  CONSTRAINT `fk_advertisment_users1` FOREIGN KEY (`users_userID`, `users_userRoleID`) REFERENCES `users` (`userID`, `userRoleID`) ON DELETE NO ACTION ON UPDATE CASCADE
...
) ENGINE=InnoDB AUTO_INCREMENT=800011 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `league` VALUES (800001,'Example League Name',NULL,990001,900000001,50001),(800002,'Example League Test Name',NULL,990001,900000005,50001),(800003,'League Test Name Test1',NULL,990001,900000001,50001),(800004,'asdfqweas','asdf aczeaf asdf',990001,900000005,50001),(800005,'madkemc','asdf acze',990001,900000005,50001),(800006,'Test 5','Now not jibberish',990001,900000005,50001),(800007,'Testing Edit','Is it Working?',990001,900000006,50001),(800008,'League Prism','Test League Adam One',990001,900000018,50001),(800009,'Tims League One','Tims First League!',990001,900000019,50001),(800010,'League Bob','League o Bob',990001,900000001,50001);
...
INSERT INTO `leaguemembers` VALUES (800001,1,900000003),(800002,1,900000006),(800003,1,900000003),(800004,1,900000003),(800008,1,900000020);
...
INSERT INTO `membershipstatuscode` VALUES (1,NULL);
...
INSERT INTO `teams` VALUES (0,'Not in a Team',900000017,800001),(2,'Team Rocket',900000001,800008),(5,'Team TestOne',900000019,800007),(6,'Team Bob',900000001,800008);
...
INSERT INTO `tournament` VALUES (1000002,'Robert Cromer','Server',800004,40001,'2017-11-10'),(1000003,'Testin Testin','Testerino',800005,40001,'2017-11-30'),(1000005,'Bren','bren',800005,40003,'2017-11-24'),(1000006,'Twilight','Sparkle',800004,40003,'2017-12-05'),(1000007,'Tournament of Bob','Bob ofc.',800001,40002,'2017-12-11'),(1000008,'Test Tourn 4','test4',800009,40002,'2017-11-22');
...
) ENGINE=InnoDB AUTO_INCREMENT=900000021 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-11-09 22:09:20
