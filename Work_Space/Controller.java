...
@FXML private JFXButton opMangArenaButton;
@FXML private JFXButton leagueOwnerGoToCreateTournsButton;
@FXML private JFXButton leagueOwnerGoToManageTournsButton;

@FXML private JFXButton opCreateArenasButton;
@FXML private JFXButton opManageArenaButton;

@FXML private JFXButton LoCreateMatch;
...
@FXML
void goToLoAppsPage(ActionEvent event) {
...
//-------------------------------------end_of_attributes----------------------------------------------------------------------
//League Owner. Go to Manage Match Button Functionality 
@FXML
private void goToCreateMatch(ActionEvent event) throws Exception
  {
