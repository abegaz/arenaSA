...
CREATE TABLE `league` (
  ...
  `users_userID` int(10) NOT NULL,
  `users_userRoleID` int(11) NOT NULL,
  PRIMARY KEY (`LeagueID`,`Arena_ArenaID`,`ExpertRatingFormula_ExpertRatingFormulaID`,`users_userID`,`users_userRoleID`),
...
CREATE TABLE `match` (
  ...
  KEY `fk_Match_Game1_idx` (`Game_GameID`),
  ...
  CONSTRAINT `fk_Match_Game1` FOREIGN KEY (`Game_GameID`) REFERENCES `game` (`GameID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_Match_Tournament1` FOREIGN KEY (`Tournament_TournamentID`, `Tournament_Arena_ArenaID`, `Tournament_League_LeagueID`, `Tournament_TournamentStyleCode_TournamentStyleCodeID`) REFERENCES `tournament` (`TournamentID`, `Arena_ArenaID`, `League_LeagueID`, `TournamentStyleCode_TournamentStyleCodeID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=900000005 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (900000000,'Admin','Password',0),(900000001,'LeagueOwner','LeagueOwnerPassword ',1),(900000002,'Advertiser','AvertiserPassword',2),(900000003,'Player','PlayerPassword',3),(900000004,'Rob','rob',4);
...
-- Dump completed on 2017-10-24 22:20:54
